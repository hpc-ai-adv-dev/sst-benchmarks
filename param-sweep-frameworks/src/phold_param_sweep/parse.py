...
from phold_param_sweep._core.launch.flux.shell import BulkSubmit as _FluxBulkSubmit
...
except _errors.StrategyLoadError as e:
...
try:
    from phold_param_sweep._core.launch.flux.api import (
        ExecutorLauncher as _FluxExecutor,
    )
except _errors.StrategyLoadError as e:
    _LOGGER.warning(str(e))
else:
    _LAUNCH_METHODS["flux-py-api"] = _FluxExecutor.default_executor
